...
| [`prometheus_port`](#prometheus_port)                       | [`PROMETHEUS`](#prometheus)       | `port`       | G     | prometheus listen port, `9058` by default          |
...
| [`alertmanager_port`](#alertmanager_port)                   | [`PROMETHEUS`](#prometheus)       | `port`       | G     | alertmanager listen port, `9059` by default        |
