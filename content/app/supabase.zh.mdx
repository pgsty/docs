...
- [`DASHBOARD_USERNAME`](https://github.com/pgsty/pigsty/blob/main/conf/supabase.yml#L136) Supabase Studio Web 界面的默认用户名，默认为 `supabase`
- [`DASHBOARD_PASSWORD`](https://github.com/pgsty/pigsty/blob/main/conf/supabase.yml#L137) Supabase Studio Web 界面的默认密码，默认为 `pigsty`
