---
title: 监控
description: 使用节点和 Linux 操作系统指标进行主机监控
icon: Telescope
---
...
[`NODE`](/zh/node/) 模块有 6 个仪表板。

[NODE Overview](https://demo.pigsty.cc/d/node-overview)：所有节点概览

[NODE Cluster](https://demo.pigsty.cc/d/node-cluster)：特定节点集群的详细信息

[NODE Instance](https://demo.pigsty.cc/d/node-instance)：单个节点实例的详细信息

[NODE Alert](https://demo.pigsty.cc/d/node-alert)：所有节点集群/实例的关键指标概览

[NODE VIP](https://demo.pigsty.cc/d/node-vip)：节点集群上 L2 VIP 的详细信息

[NODE Haproxy](https://demo.pigsty.cc/d/node-haproxy)：haproxy 负载均衡器的详细信息
