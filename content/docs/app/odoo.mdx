...
Check [`.env`](https://pigsty.io/docs/app/odoo/.env) file for configurable environment variables:
...
[Expose](https://pigsty.io/docs/tasks/nginx/) odoo seb service via nginx portal:
