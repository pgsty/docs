...
- [Quick Start](https://pigsty.io/docs/app/dify/#quick-start)
- [Why Self-Host](https://pigsty.io/docs/app/dify/#why-self-host)
- [Installation](https://pigsty.io/docs/app/dify/#installation)
- [Configuration](https://pigsty.io/docs/app/dify/#configuration)
- [Checklist](https://pigsty.io/docs/app/dify/#checklist)
- [Domain & SSL](https://pigsty.io/docs/app/dify/#domain--ssl)
- [File Backup](https://pigsty.io/docs/app/dify/#file-backup)
...
On a fresh Linux x86 / ARM server running a [**compatible distribution**](https://pigsty.io/docs/reference/compatibility/), execute:
...
First, use Pigsty’s [standard installation process](https://pigsty.io/docs/setup/install/) to install the PostgreSQL instance required by Dify:
...
-  Hardware/Software: [Prepare required machine resources](https://pigsty.io/docs/setup/prepare/): Linux `x86_64/arm64` server, fresh installation of [mainstream Linux operating systems](https://pigsty.io/docs/reference/compatibility/)
-  Network/Permissions: [SSH](https://pigsty.io/docs/setup/prepar/#management-user-preparation) passwordless login access, user has [passwordless sudo privileges](https://pigsty.io/docs/setup/prepare/#management-user-preparation)
...
- Have you modified all password-related configuration parameters?【Optional】
  ...
  -  [`pg_admin_password`](https://pigsty.io/docs/pgsql/param/#pg_admin_password): `DBUser.DBA`, PG superuser password
  -  [`pg_monitor_password`](https://pigsty.io/docs/pgsql/param/#pg_monitor_password): `DBUser.Monitor`, PG monitoring user password
  -  [`pg_replication_password`](https://pigsty.io/docs/pgsql/param/#pg_replication_password): `DBUser.Replicator`, PG replication user password
  -  [`patroni_password`](https://pigsty.io/docs/pgsql/param/#patroni_password): `Patroni.API`, Patroni HA component password
...
- [`infra_portal`](https://pigsty.io/docs/infra/param/#infra_portal) parameter’s `dify` domain
- Best to specify an email address [`certbot_email`](https://pigsty.io/docs/infra/param/#certbot_email) for receiving certificate expiration notifications
...
You can use [`restic`](https://pigsty.io/docs/tasks/restic/) to backup Dify’s filesystem. Dify’s data files are in the `/data/dify` directory. You can use the following commands to backup:
...
If you want to store all data in PostgreSQL, consider [using JuiceFS to store filesystem data in PostgreSQL](https://pigsty.io/blog/pg/pgfs/):
