...
[**Download**](/prepare/software#pigsty), [Bootstrap](/install/offline#bootstrap), [**Configure**](/config/configure) and [**Install**](/install). Pigsty [**Installed**](/install)! You can [**add more**](/install/multinode) nodes and database clusters later.
