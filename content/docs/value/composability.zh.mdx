...
<Cards>
    <Card icon={<Blocks className="text-blue-600"/>} title='模块化设计' href={"#modular-design"}>
        乐高式组装
    </Card>
    <Card icon={<Download className="text-green-600"/>} title='应用模板' href={"#app-templates"}>
        一键企业部署
    </Card>
    ...
    <Card icon={<BarChart3 className="text-red-600"/>} title='OLAP 模块' href={"#olap-modules"}>
        强大的分析能力
    </Card>
    <Card icon={<Rocket className="text-violet-600"/>} title='试验模块' href={"#pilot-modules"}>
        探索前沿边界
    </Card>
...
## 核心模块：功能齐全的 Postgres RDS [#core-modules]
...
## 风味模块：创意 Postgres 风味 [#flavor-modules]
