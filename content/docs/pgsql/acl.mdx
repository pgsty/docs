...
- Database connect privilege is covered by database [definition](/docs/pgsql/database/#define-database)
...
Database privilege is covered by [database definition](/docs/pgsql/database/#define-database).
