...
- Case 1: [Create Cluster](https://pigsty.io/docs/pgsql/admin/#create-cluster)
- Case 2: [Create User](https://pigsty.io/docs/pgsql/admin/#create-user)
- Case 3: [Create Database](https://pigsty.io/docs/pgsql/admin/#create-database)
- Case 4: [Reload Service](https://pigsty.io/docs/pgsql/admin/#reload-service)
- Case 5: [Reload HBARule](https://pigsty.io/docs/pgsql/admin/#reload-hbarule)
- Case 6: [Config Cluster](https://pigsty.io/docs/pgsql/admin/#config-cluster)
- Case 7: [Append Replica](https://pigsty.io/docs/pgsql/admin/#append-replica)
- Case 8: [Remove Replica](https://pigsty.io/docs/pgsql/admin/#remove-replica)
- Case 9: [Remove Cluster](https://pigsty.io/docs/pgsql/admin/#remove-cluster)
- Case 10: [Switchover](https://pigsty.io/docs/pgsql/admin/#switchover)
- Case 11: [Backup Cluster](https://pigsty.io/docs/pgsql/admin/#backup-cluster)
- Case 12: [Restore Cluster](https://pigsty.io/docs/pgsql/admin/#restore-cluster)
- Case 13: [Adding Packages](https://pigsty.io/docs/pgsql/admin/#adding-packages)
- Case 14: [Install Extension](https://pigsty.io/docs/pgsql/admin/#install-extension)
- Case 15: [Minor Upgrade](https://pigsty.io/docs/pgsql/admin/#minor-upgrade)
- Case 16: [Major Upgrade](https://pigsty.io/docs/pgsql/admin/#major-upgrade)
...
Note: If the database has specified an owner, the user should already exist, or you’ll have to [Create User](https://pigsty.io/docs/pgsql/admin/#create-user) first.
...
This task is used when cluster membership has changed, e.g., [append](https://pigsty.io/docs/pgsql/admin/#append-replica)/[remove](https://pigsty.io/docs/pgsql/admin/#remove-replica) replicas, [switchover](https://pigsty.io/docs/pgsql/admin/#switchover)/failover / exposing new service or updating existing service’s config (e.g., LB Weight)
...
Cluster services will be [reloaded](https://pigsty.io/docs/pgsql/admin/#reload-service) to adopt the new member
...
It will remove instance `<ip>` from cluster `<cls>`. Cluster services will be [reloaded](https://pigsty.io/docs/pgsql/admin/#reload-service) to kick the removed instance from load balancer.
...
Check [Backup](https://pigsty.io/docs/pgsql/pitr/) & PITR for details.
...
And follow the instructions wizard, Check Backup & [PITR](https://pigsty.io/docs/pgsql/pitr/) for details.
...
To add newer version of RPM packages, you have to add them to [`repo_packages`](https://pigsty.io/docs/infra/param/#repo_packages) and [`repo_url_packages`](https://pigsty.io/docs/infra/param/#repo_url_packages)
...
If you want to install extension on pg clusters, Add them to [`pg_extensions`](https://pigsty.io/docs/pgsql/param/#pg_extensions) and make sure them installed with:

```bash
./pgsql.yml -t pg_extension     # install extensions
```

Some extension needs to be loaded in `shared_preload_libraries`, You can add them to [`pg_libs`](https://pigsty.io/docs/pgsql/param/#pg_libs), or [Config](https://pigsty.io/docs/pgsql/admin/#config-cluster) an existing cluster.
...
To perform a minor server version upgrade/downgrade, you have to [add packages](https://pigsty.io/docs/pgsql/admin/#adding-packages) to yum/apt repo first.
...
The simplest way to achieve a major version upgrade is to create a new cluster with the new version, then [migration](https://pigsty.io/docs/pgsql/migration/) with logical replication & green/blue deployment.
...
Assume you want to upgrade PostgreSQL 14 to 15, you have to [add packages](https://pigsty.io/docs/pgsql/admin/#adding-packages) to yum/apt repo, and guarantee the extensions has exact same version too.
