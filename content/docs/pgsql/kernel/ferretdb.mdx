...
Use Pigsty’s [**standard installation process**](/docs/install/start/) with the [`mongo`](https://github.com/pgsty/pigsty/blob/main/conf/mongo.yml) configuration template.
