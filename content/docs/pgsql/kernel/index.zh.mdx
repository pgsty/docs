---
title: 内核
description: 用特殊的内核分支替换原版 PostgreSQL
icon: Cpu
---
...
<Callout variant="secondary">Oracle 兼容</Callout> <Callout variant="outline">社区</Callout>
...
- **迁移工具**：Oracle 到 PostgreSQL 迁移实用程序
...
<Callout variant="secondary">OLTP 优化</Callout> <Callout variant="outline">创新</Callout>
...
<Callout variant="secondary">共享存储</Callout> <Callout variant="outline">阿里云</Callout>
...
<Callout variant="secondary">Firebase 替代方案</Callout> <Callout variant="outline">自托管</Callout>
...
<Callout variant="secondary">大规模并行</Callout> <Callout variant="outline">分析</Callout>
