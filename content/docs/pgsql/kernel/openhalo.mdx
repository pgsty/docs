...
Use Pigsty’s [**standard installation process**](/docs/install/start/) with the [`mysql`](https://github.com/pgsty/pigsty/blob/main/conf/mysql.yml) configuration template.
