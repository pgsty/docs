...
[**install**](/docs/install/start) Pigsty’s with the [`polar`](https://github.com/pgsty/pigsty/blob/main/conf/polar.yml) config template.
...
Most of the **PGSQL** module’s [**extension**](/ext/list/) (non pure-SQL) cannot be used directly on the PolarDB kernel. If you need to use them, you need to recompile and install from source code for the new kernel.
