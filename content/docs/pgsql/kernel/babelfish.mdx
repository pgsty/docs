...
![img](https://pigsty.io/img/pigsty/mssql.jpg)

------

## Get Started

[**install**](/docs/install/start) Pigsty’s with the [`mssql`](https://github.com/pgsty/pigsty/blob/main/conf/mssql.yml) config template.
