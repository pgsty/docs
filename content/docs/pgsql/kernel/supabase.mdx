...
You can run the latest PostgreSQL 17(,16,15) kernels, (supabase is using the 15 currently), alone with [421](/ext/list/) PostgreSQL extensions out-of-the-box. Run on [mainstream](/prepare/linux/) Linus OS distros
