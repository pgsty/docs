...
You can also define new service in [`pg_services`](/docs/pgsql/param#pg_services). And `pg_default_services` 与 `pg_services` are both array of [Service Definition](/docs/pgsql/service/#define-service).
