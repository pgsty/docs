...
Extensions ([Package Alias](/docs/pgsql/ext/pkg)) listed in [`pg_extensions`](/docs/pgsql/param#pg_extensions) will be upgraded with [`pgsql.yml`](/docs/pgsql/admin/)'s `pg_ext` subtask:
