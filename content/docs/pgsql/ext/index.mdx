...
It takes 4 steps to deliver an extension: [**downloads**](/docs/pgsql/ext/download), [**installs**](/docs/pgsql/ext/install), [**config**](/docs/pgsql/ext/config), and [**create**](/docs/pgsql/ext/create):
