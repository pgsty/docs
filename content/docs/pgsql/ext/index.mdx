...
It takes 4 steps to deliver an extension: [**downloads**](/docs/pgsql/ext/download), [**installs**](/docs/pgsql/ext/install), [**config**](/docs/ext/config), and [**create**](/docs/pgsql/ext/create):
...
When you init this PG cluster, these extensions will be made available for your in the `pg-meta` cluster.
