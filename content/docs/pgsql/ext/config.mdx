...
While most PostgreSQL extensions written in SQL can be [**directly enabled**](/pgsql/ext/create) with `CREATE EXTENSION`, some extensions that use special postgres hook will require an extra step to **preload** them before using.
