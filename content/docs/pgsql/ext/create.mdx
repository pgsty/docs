...
The [`wal2json`](/ext/wal2json) is another important extension for Changing Data Capture (CDC). It is [installed](/docs/pgsql/ext/install) by default, but it is an [**extension without DDL**](#extension-without-ddl),
