...
[Default Database Users](/docs/pgsql/acl#default-users):
...
- [Default Roles](/docs/pgsql/acl#default-roles)
- [Default Users](/docs/pgsql/acl#default-users)
- [Default Privileges](/docs/pgsql/acl#privileges)
...
Pigsty has a built-in role system, check [PGSQL Access Control](/docs/pgsql/acl#role-system) for details.
...
Pigsty has a built-in privileges base on default role system, check [PGSQL Privileges](/docs/pgsql/acl#privileges) for details.
