...
Here are some common parameters used to identify PGSQL [entities](/docs/pgsql/config#identity-parameters): instance, service, etc…
...
Pigsty has a built-in role system, check [PGSQL Access Control](/docs/pgsql/acl) for details.
