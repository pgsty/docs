...
| [`pg_fs_main`](#pg_fs_main)                         | `path`     | C     | postgres backup data directory, `/data/backups` by default                    |
...
pg_fs_bkup: /data/backups         # postgres backup data directory, `/data/backups` by default
