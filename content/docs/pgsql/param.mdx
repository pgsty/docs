...
For example `/usr/pgsql -> /usr/pgsql-17`. For more details, check [PGSQL File Structure](/docs/reference/fhs/#postgres-fhs) for details.
...
Check [PGSQL File Structure](/docs/reference/fhs/) for details.
