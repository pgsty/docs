...
You can customize your backup policy with [`node_crontab`](/node/param#node_crontab) and [`pgbackrest_repo`](/pgsql/param#pgbackrest_repo)

- Schedule full or incr backup with [`node_crontab`](/node/param#node_crontab)
- setup backup retention policy with [`pgbackrest_repo`](/pgsql/param#pgbackrest_repo)
