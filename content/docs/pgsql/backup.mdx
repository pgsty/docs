...
You can also acquire backup info from the monitoring system: [PGCAT Instance - Backup](https://demo.pigsty.cc/d/pgcat-instance/pgcat-instance?from=now-1h&to=now&var-job=pgsql&var-ds=Prometheus&orgId=1&viewPanel=158) or the dedicate PGSQL PITR dashboard.
