...
Databases [defined](#define-database) in [`pg_databases`](/docs/pgsql/param#pg_databases) will be automatically created during module installation.
...
<Callout title="Create postgres database with pigsty" type="warn">
    ...
    Check [create database](/docs/pgsql/admin#create-database) SOP for details.
...
<Callout title="Create owner before create database" type="warn">
    ...
    In short, always [create](/docs/pgsql/admin#create-user) the [users](/docs/pgsql/user) before creating databases.
...
Pigsty will add all databases in [`pg_databases`](/docs/pgsql/param#pg_databases) to the pgbouncer database list by default.
...
When you [create databases](/docs/pgsql/database#create-database), the Pgbouncer database list definition file will be refreshed and take effect through online configuration reload, without affecting existing connections.
