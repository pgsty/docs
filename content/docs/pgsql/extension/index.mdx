...
There are **423** PostgreSQL extensions available in the [**PGSTY Extension Catalog**](https://ext.pgsty.com/):
...
[![ecosystem](/img/pigsty/ecosystem.gif)](https://ext.pgsty.com/)
