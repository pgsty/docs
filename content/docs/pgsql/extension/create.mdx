...
It is [**installed**](/pgsql/extension/install) by default (in the `pgsql-main` [alias](/pgsql/extension/pkg)) and created in the placeholder `meta` database in most [config template](/docs/config/template).
