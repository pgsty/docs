...
- [`pg_default_roles`](https://pigsty.io/docs/pgsql/param/#pg_default_roles) : Define system-wide roles & global users
- [`pg_users`](https://pigsty.io/docs/pgsql/param/#pg_users) : Define business users & roles at cluster level
...
Pigsty has a battery-included [ACL](https://pigsty.io/docs/pgsql/acl/) system, which can be easily used by assigning roles to users:
...
- [`pg_default_roles`](https://pigsty.io/docs/pgsql/param/#pg_default_roles) : System-wide roles & global users
- [`pg_default_privileges`](https://pigsty.io/docs/pgsql/param/#pg_default_privileges) : Default privileges for newly created objects
...
Users and roles defined in [`pg_default_roles`](https://pigsty.io/docs/pgsql/param/#pg_default_roles) and [`pg_users`](https://pigsty.io/docs/pgsql/param/#pg_users) will be automatically created one by one during cluster initialization.
...
Pigsty will by default add users with the `pgbouncer: true` flag in [`pg_users`](https://pigsty.io/docs/pgsql/param/#pg_users) to the pgbouncer user list.
...
Note that the [`pgbouncer_auth_query`](https://pigsty.io/docs/pgsql/param/#pgbouncer_auth_query) parameter allows you to use dynamic queries to complete connection pool user authentication, which is a compromise when you don’t want to manage users in the connection pool.