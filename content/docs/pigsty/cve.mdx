...
**etcd filled up (no auto-compaction) causing PG HA unavailable**

<Callout title="PIGSTY-20231201" type="warn">

    **Severity Level**: <span className={"text-red-500 font-extrabold"}>Critical, Please arrange fix ASAP</span>
