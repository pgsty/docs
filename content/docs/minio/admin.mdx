...
- [Create Cluster](/docs/minio/admin/#create-cluster)
- [Remove Cluster](/docs/minio/admin/#remove-cluster)
- [Expand Cluster](/docs/minio/admin/#expand-cluster)
- [Shrink Cluster](/docs/minio/admin/#shrink-cluster)
- [Upgrade Cluster](/docs/minio/admin/#upgrade-cluster)
- [Node Failure Recovery](/docs/minio/admin/#node-failure-recovery)
- [Disk failure Recovery](/docs/minio/admin/#disk-failure-recovery)
...
Step 1, add 4 node definition in the group, allocate sequence number 5 to 8. The key step is to modify the [`minio_volumes`](/docs/minio/param/#minio_volumes) param, assign the new 4 nodes to a new **storage pool**.
