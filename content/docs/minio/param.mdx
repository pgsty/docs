...
The [`minio_volumes`](#minio_volumes) and [`minio_endpoint`](minio_volumes) are auto-generated parameters, but you can explicitly override these two parameters.
...
minio node name pattern, this is used for [multi-node](https://pigsty.io/docs/minio/config/#multi-node-multi-drive) deployment
...
default values: `/data/minio`, which is a common dir for [single-node](https://pigsty.io/docs/minio/config/#single-node-single-drive) deployment.

For a [multi-drive](https://pigsty.io/docs/minio/config/#single-node-multi-drive) deployment, you can use `{x...y}` notion to specify multi drivers.
...
- In case of [SNSD](https://pigsty.io/docs/minio/config/) or [SNMD](https://pigsty.io/docs/minio/config/) deployment, `minio_volumes` directly uses the value of [`minio_data`](#minio_data)
- In case of [MNMD](https://pigsty.io/docs/minio/config/) deployment, `minio_volumes` uses the values of `minio_node`, `minio_port`, `minio_data` to generate this param:
...
Three default buckets are created for module [`PGSQL`](https://pigsty.io/docs/pgsql/), [`INFRA`](https://pigsty.io/docs/infra/), and [`REDIS`](https://pigsty.io/docs/redis/)
...
#### It's dangerous to use default passwords!