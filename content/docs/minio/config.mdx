...
To use the [exposed service](https://pigsty.io/docs/minio/config/#expose-service), you have to update/append the MinIO credential in the [`pgbackrest_repo`](/docs/pgsql/param#pgbackrest_repo) section:
