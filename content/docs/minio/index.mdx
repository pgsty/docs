...
You can uses MinIO as an optional PostgreSQL [backup](/docs/pgsql/backup) storage repo, in addition to the default local posix FS repo. If the MinIO repo is used,
