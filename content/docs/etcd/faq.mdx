...
Patroni will use the [**`pg_namespace`**](https://pigsty.io/docs/pgsql/param/#pg_namespace) (default is `/pg`) as the prefix for all metadata keys in etcd, followed by the PostgreSQL cluster name.
...
Check [Add a member to etcd cluster](https://pigsty.io/docs/etcd/admin/#add-member)
...
Check [Remove member from etcd cluster](https://pigsty.io/docs/etcd/admin/#remove-member)
