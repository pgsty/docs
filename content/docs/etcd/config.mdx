...
- [One Node](/docs/etcd/config/#one-node), no high availability, just the functionality of etcd, suitable for development, testing, demonstration.
- [Three Nodes](/docs/etcd/config/#three-nodes), basic high availability, tolerate one node failure, suitable for medium production environment.
- [Five Nodes](/docs/etcd/config/#five-nodes), better high availability, tolerate two node failure, suitable for large production environment.
