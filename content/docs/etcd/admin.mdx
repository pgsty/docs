...
Pigsty has a safeguard mechanism to prevent accidental purge. By default, [`etcd_clean`](/docs/etcd/param#etcd_clean) is `true`, and [`etcd_safeguard`](/docs/etcd/param#etcd_safeguard) is `false`,
