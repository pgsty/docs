---
title: Hardware
description: nodes, specs, disks, network, ip, domain ...
icon: Cpu
---
...
| ID | [NODE](/docs/node) | [PGSQL](/docs/pgsql)  | [INFRA](/docs/infra) | [**ETCD**](/docs/etcd) |
|:--:|:------------------:|:---------------------:|:--------------------:|:----------------------:|
| 1  |      `node-1`      | `pg-meta-2` (replica) |      `infra-1`       |        `etcd-1`        |
| 2  |      `node-2`      | `pg-meta-1` (primary) |                      |                        |
...
Internet access is required when performing the standard (online) [**installation**](/docs/setup/install).
...
It's not a big deal when running on your own hardwares,
but may become an issue when working in public cloud environment.
