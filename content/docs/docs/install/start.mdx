  ...
  children:
    ...
    pg-meta:
      ...
      vars:
        ...
        # define pg extensions: https://pgsty.com/pgsql/ext
...
Remember that most modules require the [`NODE`](/node/) module installed first. Check available [**modules**](/docs/intro/module) for detail
