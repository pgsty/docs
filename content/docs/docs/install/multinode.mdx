...
[Vagrant](/docs/prepare/vagrant) [`dual.rb`](https://github.com/pgsty/pigsty/blob/main/vagrant/spec/dual.rb) to provision this environment.
...
[Vagrant](/docs/prepare/vagrant) [`trio.rb`](https://github.com/pgsty/pigsty/blob/main/vagrant/spec/trio.rb) to provision this environment.
...
[Vagrant](/docs/prepare/vagrant) [`full.rb`](https://github.com/pgsty/pigsty/blob/main/vagrant/spec/full.rb) or [Terraform](/docs/prepare/terraform) [`full.tf`](https://github.com/pgsty/pigsty/blob/main/terraform/spec/aliyun-full.tf) to provision this environment.
...
This [`pro.yml`](https://github.com/pgsty/pigsty/blob/main/conf/build/pro.yml) is a 5-node building environment which contains supported [Linux distros](/docs/prepare/linux).
...
You can use the [Vagrant](/docs/prepare/vagrant) [`pro.rb`](https://github.com/pgsty/pigsty/blob/main/vagrant/spec/pro.rb) or [Terraform](/docs/prepare/terraform) [`pro.tf`](https://github.com/pgsty/pigsty/blob/main/terraform/spec/aliyun-pro.tf) to provision this environment.
...
You can use the [Vagrant](/docs/prepare/vagrant) [`simu.rb`](https://github.com/pgsty/pigsty/blob/main/vagrant/spec/simu.rb) to provision this environment.
