...
This happens when you run `redis.yml` to init a redis instance that is already running, and [`redis_clean`](https://pigsty.io/docs/redis/param/#redis_clean) is set to `false`.
...
> This happens when removing a redis instance with [`redis_safeguard`](https://pigsty.io/docs/redis/param/#redis_safeguard) set to `true`.

You can disable [`redis_safeguard`](https://pigsty.io/docs/redis/param/#redis_safeguard) to remove the Redis instance. This is redis_safeguard is what it is for.
