...
The entity model of Redis is almost the same as that of [PostgreSQL](/docs/concept/model/#er-diagram), which also includes the concepts of **Cluster** and **Instance**. The Cluster here does not refer to the native Redis Cluster mode.
