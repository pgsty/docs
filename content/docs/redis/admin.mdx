...
Here are some common administration tasks for Redis. Check [FAQ: Redis](https://pigsty.io/docs/redis/faq/) for more details.
...
You can partially run [`redis.yml`](https://pigsty.io/docs/redis/playbook/#redisyml) tasks to re-configure redis.
...
You can configure multiple redis master on sentinel cluster with [`redis_sentinel_monitor`](https://pigsty.io/docs/redis/param/#redis_sentinel_monitor).
