---
title: Monitor
description: redis monitor dashboards
---


## Dashboard

There are three dashboards for [`REDIS`](https://pigsty.io/docs/redis/) module.

### Redis Overview

[Redis Overview](https://demo.pigsty.io/d/redis-overview): Overview of all Redis Instances


### Redis Cluster

[Redis Cluster](https://demo.pigsty.io/d/redis-cluster) : Overview of one single redis cluster


### Redis Instance

[Redis Instance](https://demo.pigsty.io/d/redis-instance) : Overview of one single redis instance
...
- `RedisDown`：redis server is down
- `RedisRejectConn`：redis instance reject connection
