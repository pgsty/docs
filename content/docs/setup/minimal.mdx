...
There’s no [**`INFRA`**](/docs/infra/) modules, No monitoring, No [**local repo**](/docs/setup/offline/#build-local-repo) Just [**`ETCD`**](https://pigsty.io/docs/etcd/) & [**`PGSQL`**](https://pigsty.io/docs/pgsql/) and partial of [**`NODE`**](https://pigsty.io/docs/node/)
...
Packages are directly installed from the Internet upstream repo, [**offline install**](/docs/setup/offline) is not applicable here.
