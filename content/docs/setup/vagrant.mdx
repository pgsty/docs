...
Pigsty require Linux environment, you can easily create local linux VMs with [**Vagrant**](https://www.vagrantup.com/).
...
You can install vagrant, virtualbox, ansible on macOS with [**homeberw**](https://brew.sh/):
