...
[![pigsty-dashboard.jpg](https://pigsty.io/img/pigsty/dashboard.jpg)](/docs/pgsql/dashboard/)
...
The user describes the desired status with [Parameters](/docs/reference/param/) in a declarative manner, and the playbooks tune target nodes into that status in an idempotent manner. It’s like Kubernetes CRD & Operator but works on Bare Metals & Virtual Machines.
...
Check [PGSQL Conf](/docs/pgsql/conf) for details.