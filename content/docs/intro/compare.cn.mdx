...
- [**Pigsty 扩展列表**](/docs/reference/extension/)
...
| 可定制参数点  | [Pigsty Parameters](/docs/about/param/) 283 个 |                                                              |                  |
...
经验上看，软硬件资源的部分 RDS 单位成本是自建的 5 ～ 15 倍，租售比通常在一个月。详情请参考 [成本分析](/docs/reference/cost/)。
