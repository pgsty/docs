...
Use the [`infra.yml`](https://pigsty.io/docs/infra/playbook/#infrayml) playbook to install the INFRA module on Infra nodes:
...
Use the [`infra-rm.yml`](https://pigsty.io/docs/infra/playbook/#infra-rmyml) playbook to uninstall the INFRA module from Infra nodes:
...
To scale out an existing INFRA deployment, first modify the `infra` group by adding new node IPs and assigning unique [`infra_seq`](https://pigsty.io/docs/infra/param/#infra_seq) numbers:
...
Then use the [`infra.yml`](https://pigsty.io/docs/infra/playbook/#infrayml) playbook to install INFRA on the new node:
