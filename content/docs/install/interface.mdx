...
|:------------:|:--------:|:----------:|-----------------------------|--------------------------------------------|
|  **Nginx**   | `80/443` | `h.pigsty` | Portal, Repo, HAProxy Admin | [`home.pigsty.io`](https://h.pigsty.cio)   |
...
You can access the default PostgreSQL database (`meta`) @ default port `5342` via the following `PGURL`:
