...
for [high availability](https://pigsty.io/docs/concept/ha/) and [point-in-time recovery](https://pigsty.io/docs/concept/pitr/).
We developed a zero-downtime [migration](https://pigsty.io/docs/pgsql/migration/) strategy based on logical replication,
...
which consists of PostgreSQL, Redis, MinIO, and more optional [**modules**](https://pigsty.io/docs/about/module/).
