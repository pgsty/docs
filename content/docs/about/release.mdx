...
- Added support for MySQL wire-compatible PostgreSQL kernel on EL systems: [openHalo](/docs/feat/kernel#openhalo)
- Added support for OLTP-enhanced PostgreSQL kernel on EL systems: [orioledb](/docs/feat/kernel#orioledb)
