...
|:-----------------------------------|:----------:|------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| [v3.5.0](/docs/about/release#v350) | 2025-06-16 | PG18 beta, 421 ext, monitor & pgsql refactor               | [v3.5.0](https://github.com/pgsty/pigsty/releases/tag/v3.5.0)                             |
...
```bash
da9a3e69bfc34574cd65543889685707  pigsty-v3.5.0.tgz
