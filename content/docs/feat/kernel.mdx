...
|-------------------------|--------------------------|--------------------------------|
| [Citus](#citus)         | **Horizontal Scaling**   | Native Distributive PostgreSQL |
| [WiltonDB](#babelfish)  | **SQL Server Migration** | SQL Server wire-compatibility  |
| [IvorySQL](#ivorysql)   | **Oracle Migration**     | Oracle Grammar and PL/SQL      |
| [OpenHalo](#openhalo)   | **MySQL Migration**      | MySQL wire-protocol compatible |
| [OrioleDB](#orioledb)   | **OLTP Optimization**    | No bloat, cloud-native         |
| [PolarDB PG](#polardb)  | **Read Scaling**         | Shared storage architecture    |
| [Supabase](#supabase)   | **Rapid Development**    | Complete BaaS solution         |
| [Greenplum](#greenplum) | **Analytics/DW**         | Massively parallel processing  |
