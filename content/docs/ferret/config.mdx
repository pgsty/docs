...
FerretDB 2.0+ requires an extension: [DocumentDB](/ext/documentdb), which depends on several other extensions. Here’s a template for creating a PostgreSQL cluster for FerretDB:
