...
| :--------: | -------------- | :--------: | :----------------------------------------------------------: | --------------------------- |
| `h.pigsty` | `home`         | **80/443** |    [**Nginx**](https://pigsty.io/docs/infra/arch/#nginx)     | Default server, local repo  |
| `g.pigsty` | `grafana`      |  **3000**  |  [**Grafana**](https://pigsty.io/docs/infra/arch/#grafana)   | Monitoring & visualization  |
| `p.pigsty` | `prometheus`   |    9090    | [**Prometheus**](https://pigsty.io/docs/infra/arch/#prometheus) | Time series DB              |
| `a.pigsty` | `alertmanager` |    9093    | [**AlertManager**](https://pigsty.io/docs/infra/arch/#alertmanager) | Alert aggregation & routing |
...
Not a fan of default domains? Modify them in [**`infra_portal`**](https://pigsty.io/docs/infra/param/#infra_portal) before installation:
...
Pigsty [Infra module](https://pigsty.io/docs/infra/arch/#dnsmasq) includes DNS server (port 53).
...
Pigsty generates a self-signed CA in the [admin node](https://pigsty.io/docs/node/#admin-node) source directory (`~/pigsty`) during init.
