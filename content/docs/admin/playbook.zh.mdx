---
title: 剧本
description: 使用 ansible 运行 playbooks，Pigsty 中的剧本列表与说明
icon: ScrollText
---
...
|   [PGSQL](/pgsql/playbook)    | [`pgsql-pitr.yml`](https://github.com/pgsty/pigsty/blob/main/pgsql-pitr.yml)           | 在现有 PostgreSQL 集群上执行时间点恢复          |
...
|   [ETCD](/zh/etcd/playbook)   | [`etcd.yml`](https://github.com/pgsty/pigsty/blob/main/etcd.yml)                       | 初始化 etcd 集群，或扩容新成员                 |
|    [ETCD](/etcd/playbook)     | [`etcd-rm.yml`](https://github.com/pgsty/pigsty/blob/main/etcd-rm.yml)                 | 移除 etcd 集群与数据，或移除现有成员缩容            |
|  [MINIO](/zh/minio/playbook)  | [`minio.yml`](https://github.com/pgsty/pigsty/blob/main/minio.yml)                     | 初始化 minio 集群（pgbackrest 仓库可选）      |
|  [MINIO](/zh/minio/playbook)  | [`minio.yml`](https://github.com/pgsty/pigsty/blob/main/minio.yml)                     | 移除 minio 集群与数据                     |
