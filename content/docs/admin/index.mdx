...
<Cards>
    <Card icon={<TerminalIcon className="text-black"/>} title='Ansible' href={"/admin/ansible"}>
        Run admin commands with ansible
    </Card>
    <Card icon={<PlayIcon className="text-blue-500"/>} title='Playbook' href={"/admin/playbook"}>
