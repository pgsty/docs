...
这一节包含 [`etcd_remove`](https://github.com/pgsty/pigsty/blob/main/roles/etcd_remove/defaults/main.yml) 角色中定义的参数，
一些供 [`etcd-rm.yml`](/etcd/playbook/#etcd-rmyml) 剧本使用的行为控制标记。
