...
Install all extensions simultaneously is applicable (except two conflicts in the [`olap`](https://ext.pgsty.com/cate/olap/) category) but not recommended. Just install the extensions you need by explicitly specifying them in the `pg_extensions` parameter.
