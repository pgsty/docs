...
There are unparalleled [**437**](/pgsql/extension) extensions available in Pigsty for 14 mainstream [Linux distros](/prepare/linux).

--------

## Overview

It takes 4 steps to deliver an extension: [**downloads**](/pgsql/extension/download), [**installs**](/pgsql/extension/install), [**config**](/pgsql/extension/config), and [**create**](/pgsql/extension/create):
...
<Steps>
    ...
    <Step>
        ...
        [**Create**](#create-extension) : Create extension in the [database](/pgsql/db)
...
You can describe extensions in the [**config inventory**](/config/inventory), and pigsty will
...
Here's a more complicated example: launch Postgres with required extensions for [self-hosting supabase](/app/supabase):
