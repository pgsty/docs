...
pgBackRest [backup](/pgsql/backup) & [restore](/pgsql/backup/restore) command and shortcuts:
...
Check Backup & [Restore](/pgsql/backup/restore) docs for more details.
...
To add the newer version of RPM/DEB packages, you have to add them to [`repo_packages`](/infra/param#repo_packages) and [`repo_url_packages`](/infra/param#repo_url_packages)
