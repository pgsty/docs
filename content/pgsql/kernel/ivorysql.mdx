...
It’s not a wire protocol compatibility like [**Babelfish**](/pgsql/kernel/babelfish), [**openHalo**](/pgsql/kernel/openhalo/), or [**FerretDB**](/ferret/) that allows using the original client drivers.
...
IvorySQL also provides a series of [new GUC parameters](https://docs.ivorysql.org/en/ivorysql-doc/v5.0) that can be specified in [`pg_parameters`](/pgsql/param/#pg_parameters).
