...
> Check the latest self-hosting Tutorial here: [Supabase](/app/supabase/)
...
In this self-hosting deployment architecture, you gain the freedom to use different kernels (PostgreSQL 15-17, OrioleDB), the freedom to install [**437**](https://pgext.cloud/list/) extensions, the freedom to scale Supabase/Postgres/MinIO,
