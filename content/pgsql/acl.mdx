...
Pigsty has a default role system consisting of four [default roles](#default-roles) and four [default users](#default-users):
...
- Offline (`dbrole_offline`): Role for restricted read-only access ([offline](/pgsql/config/#offline) instance)

Default roles are defined in [`pg_default_roles`](/pgsql/param#pg_default_roles), changing default roles is not recommended.
...
- [`pg_dbsu`](/pgsql/param#pg_dbsu) : os dbsu name, postgres by default, better not change it
- [`pg_replication_username`](/pgsql/param#pg_replication_username) : postgres replication username, `replicator` by default
- [`pg_replication_password`](/pgsql/param#pg_replication_password) : postgres replication password, `DBUser.Replicator` by default
- [`pg_admin_username`](/pgsql/param#pg_admin_username) : postgres admin username, `dbuser_dba` by default
- [`pg_admin_password`](/pgsql/param#pg_admin_password) : postgres admin password in plain text, `DBUser.DBA` by default
- [`pg_monitor_username`](/pgsql/param#pg_monitor_username) : postgres monitor username, `dbuser_monitor` by default
- [`pg_monitor_password`](/pgsql/param#pg_monitor_password) : postgres monitor password, `DBUser.Monitor` by default
...
To define extra options, specify them in [`pg_default_roles`](/pgsql/param#pg_default_roles):
...
Default object privileges are defined in [`pg_default_privileges`](/pgsql/param#pg_default_privileges).
...
1. [`{{ pg_dbsu }}`](/pgsql/param#pg_dbsu), `postgres` by default
2. [`{{ pg_admin_username }}`](/pgsql/param#pg_admin_username), `dbuser_dba` by default
...
- If `owner` exists, it will be used as the database owner instead of default [`{{ pg_dbsu }}`](/pgsql/param#pg_dbsu)
