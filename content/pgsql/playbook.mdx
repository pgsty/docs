...
- [`pgsql-pitr.yml`](/pgsql/playbook/#pgsql-pitryml) : Perform point-in-time recovery on existing PostgreSQL cluster
...
The playbook [`pgsql-pitr.yml`](https://github.com/pgsty/pigsty/blob/main/pgsql-pitr.yml) can perform point-in-time recovery on existing PostgreSQL cluster.

Check admin SOP: [`Restore`](/pgsql/backup/restore)
