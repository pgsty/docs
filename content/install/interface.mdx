...
<Callout title="Access via domain name" type="warning">
    ...
    Pigsty support static [local domain (fake)](/zh/admin/domain#local-static-resolution) for web components, you can access Grafana via `http://g.pigsty` through Nginx
