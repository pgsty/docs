...
And provision VM with [Vagrant](/zh/prepare/vagrant) [`meta.rb`](https://github.com/pgsty/pigsty/blob/main/vagrant/spec/meta.rb)
or [Terraform](/zh/prepare/terraform) [`meta.tf`](https://github.com/pgsty/pigsty/blob/main/terraform/spec/aliyun-meta.tf).
...
You can use the [`dual.yml`](https://github.com/pgsty/pigsty/blob/main/conf/ha/dual.yml) config template, and provision required VM with:
