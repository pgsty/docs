...
如果您想安装 Prometheus / Grafana 可观测性堆栈，Pigsty 为您提供最佳实践！它具有适用于 [节点](https://g.pgsty.com/d/node-overview) 和 [PostgreSQL](https://g.pgsty.com/d/pgsql-overview) 的细粒度仪表板，无论这些节点或 PostgreSQL 服务器是否由 Pigsty 管理，您都可以通过简单的配置立即获得生产级监控和告警。
