...
Pigsty has a repository that provides 200+ extra PostgreSQL extensions on 10 mainstream [linux distro](/docs/prepare/linux/).
It is designed to work together with the official PostgreSQL Global Development Group ([PGDG](https://www.postgresql.org/download/linux/)) repository.
...
Pigsty has two major repos: [INFRA](/ext/repo/infra/) and [PGSQL](https://repo.pigsty.io/ext/repo/pgsql/),
