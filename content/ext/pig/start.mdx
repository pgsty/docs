...
[![pig.svg](/img/asciinema/pig.svg)](https://asciinema.org/a/695902)
...
The default `pig repo add pigsty pgdg` will add the [`PGDG`](https://www.postgresql.org/download/linux/) repo and [`PIGSTY`](/ext/usage/repo) repo to your system.
