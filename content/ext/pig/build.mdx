...
- [**EL distributions**](https://pigsty.io/ext/repo/yum/): RHEL, Rocky, CentOS (tested on versions 8 and 9)
- [**DEB distributions**](https://pigsty.io/ext/repo/apt/): Debian (tested on versions 12), Ubuntu (tested on versions 22.04 and 24.04)
