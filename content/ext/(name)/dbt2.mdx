...
|:--------:|:--------:|:----------:|:--------------:|:---------------------------------------:|:------------------------------------------------------:|:----:|
| **3220** | [`dbt2`](https://github.com/osdldbt/dbt2) | `dbt2` | 0.45.0 | <Badge icon={<BookA />} variant="teal-subtle"><a href="/ext/lang" className="no-underline">LANG</a></Badge> | <a href="/ext/list/license#artistic" className="no-underline"><Badge icon={<Scale />} variant="green-subtle">Artistic</Badge></a> | <a href="/ext/list/lang#c"><Badge icon={<FileCode2 />} variant="blue-subtle">C</Badge></a> |
