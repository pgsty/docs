---
title: RPM Release
description: PostgreSQL & Extension RPM packages changelog and release note
icon: GraduationCap
---

Check [`pgsty/rpm`](https://github.com/pgsty/rpm) repo for build specs and [`pigsty-pgsql`](https://ext.pgsty.com/repo/pgsql) for usage
