...
Check [`pgsty/infra-pkg`](https://github.com/pgsty/infra-pkg) repo for build specs and [`pigsty-infra`](https://ext.pgsty.com/repo/infra) for usage

```bash title="pig"
curl https://repo.pigsty.io/pig | bash      # download and install the pig CLI tool
pig repo add infra -u                       # add pigsty-pgsql repo and update cache
```
...
|:---------------------------|:-------:|:-------:|:-------------------------|
| grafana                    | 12.1.0  | 12.2.1  | download address changed |
