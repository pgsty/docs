---
title: PG Exporter
description: the pg_exporter metrics collector release note
icon: SearchSlash
---
...
Check the [GitHub Repo](https://github.com/pgsty/pg_exporter) for more details.
...
|:---------------:|:----------:|---------------------------------------------------------|:------------------------------------------------------------------:|
| [v1.0.2](#v102) | 2023-08-14 | CI/CD Pipeline with go 1.25, https://exp.pgsty.com      | [v1.0.2](https://github.com/pgsty/pg_exporter/releases/tag/v1.0.2) |
...
- Release with goreleaser for more os/arch with GitHub CI/CD pipeline:
