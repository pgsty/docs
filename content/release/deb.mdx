---
title: DEB Release
description: PostgreSQL & Extension DEB packages changelog and release note
icon: Shell
---

Check [`pgsty/deb`](https://github.com/pgsty/deb) repo for build specs and [`pigsty-pgsql`](https://ext.pgsty.com/repo/pgsql) for usage
