...
|  [PGSQL](/pgsql/playbook)  | [`pgsql-pitr.yml`](https://github.com/pgsty/pigsty/blob/main/pgsql-pitr.yml)           | Run point-in-time-recovery on existing PostgreSQL cluster   |
...
|   [ETCD](/etcd/playbook)   | [`etcd.yml`](https://github.com/pgsty/pigsty/blob/main/etcd.yml)                       | Init etcd cluster, or append new member                     |
|   [ETCD](/etcd/playbook)   | [`etcd-rm.yml`](https://github.com/pgsty/pigsty/blob/main/etcd-rm.yml)                 | Remove etcd cluster, or remove existing member              |
|  [MINIO](/minio/playbook)  | [`minio.yml`](https://github.com/pgsty/pigsty/blob/main/minio.yml)                     | Init minio cluster                                          |
|  [MINIO](/minio/playbook)  | [`minio-rm.yml`](https://github.com/pgsty/pigsty/blob/main/minio-rm.yml)               | Remove minio cluster                                        |
