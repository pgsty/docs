...
- [http://10.10.10.10:9058](http://10.10.10.10:9058/) 是 Prometheus TSDB 控制台
- [http://10.10.10.10:9059](http://10.10.10.10:9059/) 是 AlertManager 控制台
...
| `p.pigsty` | `prometheus`   |    9058    |   [**Prometheus**](/zh/infra/arch/#prometheus)   | 时间序列数据库              |
| `a.pigsty` | `alertmanager` |    9059    | [**AlertManager**](/zh/infra/arch/#alertmanager) | 警报聚合和路由 |
